        ...
        <div class="main-panel">
            <div class="content">
                <div class="page-inner mt--12">
                    ...
                    <div class="row">
                        <div class="col-md-6 ml-auto mr-auto mt-auto mb-auto">
                            <div class="card full-height">
                                <div class="card-body text-center">
                                    <div class="form-group">
                                        <div class="card-title">Welcome to Veap TV!</div>
                                        <div class="card-category">Get started by clicking the button below.</div>

                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <button class="btn btn-danger btn-round"><i class="fas fa-plus"></i> Create Event</button>
                                            </div>
                                        </div>
                                    </div>
